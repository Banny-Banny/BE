...
export const ErrorMessages: Record<ErrorCode, string> = {
  ...
  // 카카오
  [ErrorCode.INVALID_CODE]: '유효하지 않거나 이미 사용된 카카오 인가 코드입니다.',
  [ErrorCode.INSUFFICIENT_SCOPE]: '동의창에서 친구 목록 항목을 체크 해제했습니다.',
  ...
  [ErrorCode.LATITUDE_REQUIRED_FOR_EASTER_EGG]: '이스터에그 생성 시 위도는 필수입니다.',
  [ErrorCode.LONGITUDE_REQUIRED_FOR_EASTER_EGG]: '이스터에그 생성 시 경도는 필수입니다.',
  ...
  [ErrorCode.INCOMPLETE_PARTICIPANTS]: '모든 참여자가 저장을 완료해야 제출할 수 있습니다.',
